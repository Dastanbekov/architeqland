  ...
  useEffect(() => {
    ...
    const fragmentShaderSrc = `
      ...
      void main() {
        ...
        // Indigo theme base color (#6366f1 is roughly 0.39, 0.40, 0.95)
        vec3 baseColor = vec3(0.39, 0.40, 0.95) * 0.6 + 0.4 * cos(t * 0.5 + vec3(0.0, 0.2, 0.4));
        baseColor *= 1.0 - smoothstep(0.01, 0.05, pattern);
        baseColor += pow(1.0 - b.x, 8.0) * 0.15;
